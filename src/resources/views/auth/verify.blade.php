...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Pagina de Verificação</title>
                                    ...
                                    <div class="pt-0">
                                        <form method="POST" action="{{ route('custom.verification.verify') }}" class="my-4">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input class="form-control" type="text" id="code" required="" name="code" placeholder="Digite seu código de verificação">
                                                @error('code')
                                        ...
                                        <div class="text-center text-muted mb-4">
                                            <p class="mb-0">Não tem uma conta ?<a class='text-primary ms-2 fw-medium' href="{{ route('register') }}">Cadastre-se</a></p>
                                        </div>
