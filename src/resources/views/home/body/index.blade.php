<!DOCTYPE html>
<htm  <link rel="stylesheet" href="{{asset('frontend/assets/css/fontawesome.css')}}">
...
<head>
  ...
  <title>Tecnológicos - IT Solution & Technology Temaptle</title>
  ...
  <link rel="stylesheet" href="{{asset('frontend/ssets/css/magnific-popup.css')}}a">
      ...
      <div class="lonyo-faq-wrap1">
        ...
        <div class="lonyo-faq-item item2" data-aos="fade-up" data-aos-duration="1100">
          <div class="lonyo-faq-header">
            ...
            <div class="lonyo-active-icon">
              <img class="plasicon" src="{{asset('frontend')}}{{asset('frontend')}}assets/images/v1/mynus.svg" alt="">
