                    ...
                    <div class="container-xxl">
                        ...
                        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                            <div class="flex-grow-1">
                                <h4 class="fs-18 fw-semibold m-0">Editar Avaliação</h4>
                            </div>
                        </div>
                                        ...
                                        <ul class="nav nav-underline border-bottom pt-2" id="pills-tab" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link active p-2" id="setting_tab" data-bs-toggle="tab" href="#profile_setting" role="tab" aria-selected="true">
                                                    ...
                                                    <span class="d-none d-sm-block">Editar avaliação</span>
                                                </a>
                                            </li>
                                        </ul>
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="form-group mb-3 row">
                                                                            ...
                                                                            <div class="col-lg-12 col-xl-12">
                                                                                <input class="form-control" type="text" name="name" placeholder="Digite o nome completo" value="{{ $review->name }}" required>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group mb-3 row">
                                                                            ...
                                                                            <div class="col-lg-12 col-xl-12">
                                                                                <input class="form-control" type="text" name="position" placeholder="Ex: CEO, Gerente, Cliente, etc." value="{{ $review->position }}" required>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group mb-3 row">
                                                                            ...
                                                                            <div class="col-lg-12 col-xl-12">
                                                                                <textarea class="form-control" rows="4" name="message" placeholder="Digite a mensagem de avaliação..." required>{{ $review->message }}</textarea>
                                                                            </div>
                                                                        </div>
