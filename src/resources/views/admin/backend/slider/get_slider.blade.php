                    ...
                    <div class="container-xxl">
                        ...
                        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                            <div class="flex-grow-1">
                                <h4 class="fs-18 fw-semibold m-0">Editar Slider</h4>
                            </div>
                        </div>
                                        ...
                                        <ul class="nav nav-underline border-bottom pt-2" id="pills-tab" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link active p-2" id="setting_tab" data-bs-toggle="tab" href="#profile_setting" role="tab" aria-selected="true">
                                                    ...
                                                    <span class="d-none d-sm-block">Editar Slider</span>
                                                </a>
                                            </li>
                                        </ul>
                                                                    ...
                                                                    <form action="{{ route('update.review') }}" method="POST" enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="form-group mb-3 row">
                                                                            ...
                                                                            <div class="col-lg-12 col-xl-12">
                                                                                <input class="form-control" type="text" name="title" placeholder="Digite o nome completo" value="{{ $slider->name }}" required>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group mb-3 row">
                                                                            ...
                                                                            <div class="col-lg-12 col-xl-12">
                                                                                <input class="form-control" type="text" name="link" placeholder="Digite o link" value="{{ $slider->link }}" required>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group mb-3 row">
                                                                            ...
                                                                            <div class="col-lg-12 col-xl-12">
                                                                                <textarea class="form-control" rows="4" name="descricao" placeholder="Digite a mensagem do slider..." required>{{ $slider->discription }}</textarea>
                                                                            </div>
                                                                        </div>

                                                                        <div class="form-group mb-3 row">
                                                                            <label class="form-label">Slider Foto</label>
                                                                            <div class="col-lg-12 col-xl-12">
                                                                        ...
                                                                        <div class="form-group mb-3 row">
                                                                            ...
                                                                            <div class="col-lg-12 col-xl-12">
                                                                                <img id="showImage" src="{{ asset($review->image) }}" class="rounded-circle avatar-xxl img-thumbnail float-start" alt="Pré-visualização da imagem">
                                                                            </div>
                                                                        </div>
